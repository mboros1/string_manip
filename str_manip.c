...
void benchmark_strlen(const char *filename, size_t (*strlen_func)(const char *), const char *func_name) {
...
int main(int argc, char *argv[]) {
    ...
    printf("Benchmarking standard strlen...\n");
    benchmark_strlen(filename, strlen_standard, "standard strlen");

    printf("Benchmarking SSE2 optimized strlen...\n");
